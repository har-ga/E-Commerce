...
public class CartController {
    ...
    public ResponseEntity<ApiResponse> updateProduct(@RequestBody AddToCartDto addToCartDto, @RequestParam("token") String token) 
        ...
        return new ResponseEntity<>(new ApiResponse(true, "Changed Successfully"), HttpStatus.CREATED);
